...
const Footer = () => {
  return (
    <footer className="flex flex-col w-full gap-12 p-6 items-center justify-between bg-zinc-900 py-6">
      <p className="text-center text-9xl font-italiana text-slate-50 font-semibold"><a href="https://github.com/cadupinello" target="_blank" rel="noreferrer">Carlos Eduardo</a></p>
